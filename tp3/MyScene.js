...
export class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        this.woodMaterial.setAmbient(0.76, 0.50, 0.24, 1.0);
        this.woodMaterial.setDiffuse(0.76, 0.50, 0.24, 1.0); 
    ...
    display() {
        ...
        this.lights[0].update();
        this.lights[1].update();
        this.setGlobalAmbientLight(this.globalLightIntensity, this.globalLightIntensity, this.globalLightIntensity, 1.0);
